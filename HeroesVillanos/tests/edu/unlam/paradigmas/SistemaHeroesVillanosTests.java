...
public class SistemaHeroesVillanosTests {
	...
	public void HeroeGanaVillanoPorVelocidad() {
		...
		//System.out.println(sistema.enfrentar(h1, v1, car.valueOf("VELOCIDAD")));
		assertEquals(1, sistema.enfrentar(h1, v1, car.valueOf("VELOCIDAD")));
	}
	...
	public void heroeGanaVillanoPorFuerza() {
		...
		assertEquals(1, sistema.enfrentar(h2, v2, car.valueOf("FUERZA")));
	}
	...
	public void heroeGanaVillanoPorResistencia() {
		...
		assertEquals(1, sistema.enfrentar(h3, v1, car.valueOf("RESISTENCIA")));
	}
	...
	public void heroeGanaVillanoPorDestreza() {
		...
		assertEquals(1, sistema.enfrentar(h1, v2, car.valueOf("DESTREZA")));
	}
	
	
	@Test
	public void heroeEmpataConVillano() {
		assertEquals(0, sistema.enfrentar(h5, v3, car.valueOf("VELOCIDAD")));
	}
	...
	public void heroeGanaVillanoYVuelvaAVelocidadRec() {
		...
		assertEquals(1, sistema.enfrentar(h4, v3, car.valueOf("DESTREZA")));
	}
	...
	public void ligaHeroeGanaVillanoPorVelocidad() {
		...
		assertEquals(sistema.enfrentar(ligaHeroes, v4, car.valueOf("VELOCIDAD")), 1);
	}
	...
	public void ligaHeroeGanaVillanoPorFuerza() {
		...
		assertEquals(sistema.enfrentar(ligaHeroes, v4, car.valueOf("FUERZA")), 1);
	}
	...
	public void ligaHeroeGanaVillanoPorResistencia() {
		...
		assertEquals(sistema.enfrentar(ligaHeroes, v4, car.valueOf("RESISTENCIA")), 1);
	}
	...
	public void ligaHeroeGanaVillanoPorDestreza() {
		...
		assertEquals(sistema.enfrentar(ligaHeroes, v4, car.valueOf("DESTREZA")), 1);
	}
	...
	public void ligaHeroeEmpataVillano()
	{
		...
		//System.out.println(sistema.enfrentar(ligaHeroes, v5, Caracteristica.TipoCaracteristica.valueOf("VELOCIDAD")));
		assertEquals(sistema.enfrentar(ligaHeroes, v5, car.valueOf("VELOCIDAD")), 0);
	}
	/*
	@Test
